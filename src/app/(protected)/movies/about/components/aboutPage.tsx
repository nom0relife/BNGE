    ...
    <section className="min-h-screen bg-gradient-to-b from-[#18122B] via-[#232038] to-[#393053] flex items-center
     justify-center px-4">
      <div className="max-w-2xl w-full
        ...
        ">
        <h1 className="text-3xl md:text-3xl font-extrabold text-purple-300 mb-5 tracking-tight
         drop-shadow-[0_4px_12px_rgba(160,132,220,0.2)]">
                    About <span className="text-[#A084DC]">BNGE</span>
        </h1>
        <p className="text-base md:text-lg text-purple-100 mb-8 font-light leading-relaxed">
          <b>BNGE</b> is your all-in-one platform for discovering and tracking your favorite entertainment — movies,
        ...
        <div className="mb-8">
          ...
          <p className="text-purple-100 font-light">
                        ...
                        BNGE aims to bring together a community of like-minded people
